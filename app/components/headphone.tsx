...
const Eyes = ({ type }: { type: number }) => {
  ...
  return (
    <motion.g
      ...
      transition={{ duration: 0.25 }}
    >
      <circle cx="24" cy="36" r="3.5" fill="#22343D" />
      <circle cx="40" cy="36" r="3.5" fill="#22343D" />
    </motion.g>
  );
};
...
const Face = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-black">
      ...
      >
        {/* FACE */}
        <circle cx="35" cy="35" r="30" fill="#CBD4D8" />

        {/* EYES */}
        <AnimatePresence mode="wait">
          <Eyes key={eyeState} type={eyeState} />
        </AnimatePresence>

        {/* MOUTH */}
        <path
          d="M24 48 Q35 56 46 48"
          stroke="#22343D"
          strokeWidth="2.5"
          fill="transparent"
          strokeLinecap="round"
